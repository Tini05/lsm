...
const translations = {
  en: {
    ...
    localSaveNote: "Saved on this device so you can compare later.",
    shareListing: "Share listing",
    statusLabel: "Status",
    locationLabelFull: "Location",
    feedbackSidebarBlurb: "Use ratings and quick notes to remember which listings you like.",
    expires: "Expires",
    months: "month/s",
  ...
  sq: {
    ...
    feedbackSaved: "Përshtypja u ruajt lokalisht",
    noFeedback: "Ende pa komente",
    recentFeedback: "Komente të fundit",
    localSaveNote: "Ruhet në këtë pajisje që të kujtohet më vonë.",
    shareListing: "Shpërndaj listimin",
    statusLabel: "Statusi",
    locationLabelFull: "Lokacioni",
    feedbackSidebarBlurb: "Përdor vlerësimet dhe shënimet e shpejta për të mbajtur mend listimet e preferuara.",
    expires: "Skadon",
    months: "muaj",
  ...
  mk: {
    ...
    feedbackSaved: "Мислењето е зачувано локално",
    noFeedback: "Нема коментари сè уште",
    recentFeedback: "Скорашни коментари",
    localSaveNote: "Се чува на овој уред за подоцна споредување.",
    shareListing: "Сподели оглас",
    statusLabel: "Статус",
    locationLabelFull: "Локација",
    feedbackSidebarBlurb: "Користи оцени и брзи белешки за да запомниш кои огласи ти се допаѓаат.",
    expires: "Истекува",
    months: "месец/и",
    allListingsHint:
